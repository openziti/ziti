...
func NewDialLinkChannel(dialer channel.DialUnderlayFactory, underlay channel.Underlay, maxDefaultChannels, maxAckChannel int) UnderlayHandlerLinkChannel {
	...
	result.constraints.AddConstraint(ChannelTypeAck, maxAckChannel, 0)

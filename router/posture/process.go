...
func (p *ProcessCheck) requireAll(cache *Cache) *CheckError {
	...
	cacheProcesses := map[string]*edge_ctrl_pb.PostureResponse_Process{}
...
func (p *ProcessCheck) compareProcesses(osType string, given *edge_ctrl_pb.PostureResponse_Process, valid *edge_ctrl_pb.DataState_PostureCheck_Process) *FailedValueError[*edge_ctrl_pb.DataState_PostureCheck_Process] {

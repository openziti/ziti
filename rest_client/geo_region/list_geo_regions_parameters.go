...
// NewListGeoRegionsParams creates a new ListGeoRegionsParams object
// with the default values initialized.
func NewListGeoRegionsParams() *ListGeoRegionsParams {
	var ()
	return &ListGeoRegionsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewListGeoRegionsParamsWithTimeout creates a new ListGeoRegionsParams object
...
// NewListGeoRegionsParamsWithContext creates a new ListGeoRegionsParams object
...
// NewListGeoRegionsParamsWithHTTPClient creates a new ListGeoRegionsParams object
...
/*ListGeoRegionsParams contains all the parameters to send to the API endpoint
for the list geo regions operation typically these are written to a http.Request
*/
...
func (o *ListGeoRegionsParams) WithContext(ctx context.Context) *ListGeoRegionsParams {
	o.SetContext(ctx)
	return o
}

...
type ClientService interface {
	CreateSession(params *CreateSessionParams, authInfo runtime.ClientAuthInfoWriter) (*CreateSessionCreated, error)
	...
	DetailSessionRoutePath(params *DetailSessionRoutePathParams, authInfo runtime.ClientAuthInfoWriter) (*DetailSessionRoutePathOK, error)

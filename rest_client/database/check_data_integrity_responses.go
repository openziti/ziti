...
func (o *CheckDataIntegrityOK) Error() string {
	return fmt.Sprintf("[POST /database/checkDataIntegrity][%d] checkDataIntegrityOK  %+v", 200, o.Payload)
}
...
func (o *CheckDataIntegrityUnauthorized) Error() string {
	return fmt.Sprintf("[POST /database/checkDataIntegrity][%d] checkDataIntegrityUnauthorized  %+v", 401, o.Payload)
}

...
func Test_EdgeRouterPolicy(t *testing.T) {
	...
	ctx.AdminSession.validateAssociations(edgeRouter1, "edge-router-policies", policy1, policy2, policy4)
	ctx.AdminSession.validateAssociations(edgeRouter2, "edge-router-policies", policy1, policy2, policy3, policy4)
	ctx.AdminSession.validateAssociations(edgeRouter3, "edge-router-policies", policy2, policy3, policy4)

	ctx.AdminSession.validateAssociations(identity1, "edge-router-policies", policy1, policy2, policy4)
	...
	ctx.AdminSession.validateAssociations(edgeRouter1, "edge-router-policies", policy2, policy4)
	ctx.AdminSession.validateAssociations(edgeRouter2, "edge-router-policies", policy1, policy2, policy3, policy4)
	ctx.AdminSession.validateAssociations(edgeRouter3, "edge-router-policies", policy2, policy3, policy4)

	ctx.AdminSession.validateAssociations(identity1, "edge-router-policies", policy2, policy4)
	ctx.AdminSession.validateAssociations(identity2, "edge-router-policies", policy1, policy2, policy3, policy4)
	ctx.AdminSession.validateAssociations(identity3, "edge-router-policies", policy1, policy2, policy3, policy4)

	ctx.AdminSession.requireDeleteEntity(policy2)

	ctx.AdminSession.validateAssociations(edgeRouter1, "edge-router-policies", policy4)
	ctx.AdminSession.validateAssociations(edgeRouter2, "edge-router-policies", policy1, policy3, policy4)

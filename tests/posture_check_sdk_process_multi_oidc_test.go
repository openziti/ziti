...
func Test_PostureCheck_SDK_Process_Multi_OIDC(t *testing.T) {
	...
	postureCheckProcessMulti, err := adminManagementApi.CreatePostureCheckProcessMulti([]*rest_model.ProcessMulti{targetProcess}, rest_model.SemanticAnyOf, []string{postureCheckRoleAttr})
	ctx.Req.NoError(err)

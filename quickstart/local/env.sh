...
export ZITI_EDGE_WSS_ROUTER_NAME="${ZITI_EDGE_WSS_ROUTER_NAME}"
...
export ZITI_ZAC_HOSTNAME="${ZITI_ZAC_HOSTNAME}"
export ZITI_EDGE_ROUTER_HOSTNAME="${ZITI_EDGE_ROUTER_HOSTNAME}"
export ZITI_EDGE_WSS_ROUTER_HOSTNAME="${ZITI_EDGE_WSS_ROUTER_HOSTNAME}"

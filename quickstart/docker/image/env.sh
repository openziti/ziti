...
export ZITI_CONTROLLER_RAWNAME="controller"
export ZITI_EDGE_CONTROLLER_RAWNAME="edge-controller"
...
export ZITI_ROUTER_BR_HOSTNAME="${ZITI_NETWORK}-${ZITI_ROUTER_BR_RAWNAME}${ZITI_DOMAIN_SUFFIX}"
export ZITI_ROUTER_BLUE_HOSTNAME="${ZITI_NETWORK}-${ZITI_ROUTER_BLUE_RAWNAME}${ZITI_DOMAIN_SUFFIX}"
export ZITI_ROUTER_RED_HOSTNAME="${ZITI_NETWORK}-${ZITI_ROUTER_RED_RAWNAME}${ZITI_DOMAIN_SUFFIX}"
...
export ZITI_CONTROLLER_RAWNAME="${ZITI_CONTROLLER_RAWNAME}"
export ZITI_EDGE_CONTROLLER_RAWNAME="${ZITI_EDGE_CONTROLLER_RAWNAME}"

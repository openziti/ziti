...
export ZITI_EDGE_ROUTER_PORT="1280"
...
export ZITI_CONTROLLER_HOSTNAME="${ZITI_NETWORK}-${ZITI_CONTROLLER_NAME}${ZITI_DOMAIN_SUFFIX}"
...
export ZITI_EDGE_API_HOSTNAME="${ZITI_EDGE_ROUTER_HOSTNAME}:${ZITI_EDGE_ROUTER_PORT}"
...
export ZITI_EDGE_ROUTER_PORT="${ZITI_EDGE_ROUTER_PORT}"

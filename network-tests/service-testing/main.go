...
var m = &model.Model{
			...
			Hosts: model.Hosts{
				...
				"router-east-server": {
					...
					Components: model.Components{
						...
						//"tun-east-server": {
						//	Scope:          model.Scope{Tags: model.Tags{"terminator", "iperf-server", "sdk-app"}},
						//	BinaryName:     "ziti-edge-tunnel",
						//	PublicIdentity: "tun-east-server",
						//	RunWithSudo:    true,
						//},
					},
				},
	...
	Distribution: model.DistributionStages{
		...
		rsync.RsyncStaged(),
		rsync.NewRsyncHost("#ctrl", "/home/padibona/.fablab/instances/services-pete/kit/ctrl.db", "/home/ubuntu/fablab/ctrl.db"),
	},

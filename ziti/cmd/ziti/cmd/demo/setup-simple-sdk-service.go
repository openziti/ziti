...
//go:embed setup-scripts/simple-echo-sdk-hosted.md
var simpleEchoSdkHostedScriptSource []byte

type simpleEchoSdkHosted struct {
	api.Options
	tutorial2.TutorialOptions
	interactive bool
}

func newSimpleEchoSdkHostedCmd(p common.OptionsProvider) *cobra.Command {
	options := &simpleEchoSdkHosted{
		Options: api.Options{
			CommonOptions: p(),
		},
	}
	...
	cmd := &cobra.Command{
		Use:   "setup-simple-echo-sdk-hosted",
		Short: "Walks you through configuration for a simple sdk hosted sdk service",
...
func (self *simpleEchoSdkHosted) run() error {
	...
	return t.Run(simpleEchoSdkHostedScriptSource)
}

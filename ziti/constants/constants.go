...
const (
	...
	CtrlEdgeAdvertisedAddressVarDescription          = "The controller's edge API address; defaults to ZITI_CTRL_ADVERTISED_ADDRESS"
	CtrlEdgeAltAdvertisedAddressVarName              = "ZITI_CTRL_EDGE_ALT_ADVERTISED_ADDRESS"
	CtrlEdgeAltAdvertisedAddressVarDescription       = "The controller's edge API alternative address; defaults ZITI_CTRL_EDGE_ADVERTISED_ADDRESS"
	...
	ZitiEdgeRouterNameVarDescription                 = "A filename prefix for the router's key and certs; overriden by ziti create config --routerName"
	...
	ZitiEdgeRouterIPOverrideVarDescription           = "Additional IP SAN of the router; defaults to ZITI_ROUTER_ADVERTISED_ADDRESS"
	...
	ZitiEdgeRouterListenerBindPortVarDescription     = "TCP port where the router will listen for and advertise links to other routers; defaults to ZITI_ROUTER_PORT"
	...
	ZitiRouterCsrSansDnsVarDescription               = "Additional DNS SAN of the router; defaults to ZITI_ROUTER_ADVERTISED_ADDRESS"
)

...
const (
	...
	PkiAltServerCertVarDescription                   = "Alternative server certificate for the edge controller. Must be specified with ZITI_PKI_ALT_SERVER_KEY"
	PkiAltServerKeyVarName                           = "ZITI_PKI_ALT_SERVER_KEY"
	PkiAltServerKeyVarDescription                    = "Key to use with the alternative server certificate for the Ziti Edge Controller. Must be specified with ZITI_PKI_ALT_SERVER_CERT"

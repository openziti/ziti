...
const (
	...
	CtrlPkiAltServerCertVarName                      = "ZITI_PKI_ALT_SERVER_CERT"
	CtrlPkiAltServerCertVarDescription               = "Alternative server certificate for the edge controller. Must be specified with ZITI_PKI_ALT_SERVER_KEY"
	CtrlPkiAltServerKeyVarName                       = "ZITI_PKI_ALT_SERVER_KEY"
	CtrlPkiAltServerKeyVarDescription                = "Key to use with the alternative server certificate for the Ziti Edge Controller. Must be specified with ZITI_PKI_ALT_SERVER_CERT"

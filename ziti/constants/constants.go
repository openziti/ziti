...
const (
	...
	CtrlTrustDomainVarName                           = "ZITI_TRUST_DOMAIN"
	CtrlTrustDomainVarDescription                    = "Permanent SPIFFE trust domain, e.g., spiffe://ziti.example.com"
	CtrlAdditionalTrustDomainsVarName                = "ZITI_ADDITIONAL_TRUST_DOMAINS"
	CtrlAdditionalTrustDomainsVarDescription         = "secondary trust domains as a comma separated list"

...
func rootPreRun(cmd *cobra.Command, _ []string) {
	...
	// Must happen before the subcommand's RunE/Run (e.g. tproxy's interceptor construction),
	// which reads the DNS intercept IP range to install the local route on lo.

...
type TerminatorDetailLimited struct {
	BaseEntity
...
// Validate validates this terminator detail limited
...
func (m *TerminatorDetailLimited) validateIdentity(formats strfmt.Registry) error {
...
func (m *TerminatorDetailLimited) validateRouterID(formats strfmt.Registry) error {
...
func (m *TerminatorDetailLimited) validateService(formats strfmt.Registry) error {
...
func (m *TerminatorDetailLimited) validateServiceID(formats strfmt.Registry) error {
...
func (m *TerminatorDetailLimited) UnmarshalBinary(b []byte) error {
	var res TerminatorDetailLimited

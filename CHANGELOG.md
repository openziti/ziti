...
* github.com/openziti/foundation/v2: [v2.0.86 -> v2.0.104](https://github.com/openziti/foundation/compare/v2.0.86...v2.0.104)
...
* github.com/openziti/edge-api: [v0.27.5 -> v0.36.1](https://github.com/openziti/edge-api/compare/v0.27.5...v0.36.1)
    * [Issue #209](https://github.com/openziti/edge-api/pull/209) - Add buildFlags to the version response
    * [Issue #204](https://github.com/openziti/edge-api/pull/204) - Expose full router capabilities on the edge router APIs
    * [Issue #202](https://github.com/openziti/edge-api/pull/202) - Add router version and capabilities to edge router APIs
    ...
    * [Issue #194](https://github.com/openziti/edge-api/pull/194) - Add controllers to enrollment responses

...
# options passed to gox for all architectures
BUILDFLAGS_COMMON := -verbose -cgo
...
cmd-ziti-tunnel:
	cd ziti-tunnel/cmd; $(call make-target,ziti-tunnel)
...
ziti-controller-common:
	...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=/opt/osxcross/target/bin/o64-clang CXX=/opt/osxcross/target/bin/o64-clang++ gox ${BUILDFLAGS_COMMON} -os="darwin" -arch=amd64 $(BUILDFLAGS_DARWIN_AMD64) github.com/netfoundry/ziti-cmd/ziti-controller/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) gox ${BUILDFLAGS_COMMON} -os="linux" -arch=amd64 $(BUILDFLAGS_LINUX_AMD64) github.com/netfoundry/ziti-cmd/ziti-controller/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=arm-linux-gnueabihf-gcc gox ${BUILDFLAGS_COMMON} -os="linux" -arch=arm $(BUILDFLAGS_LINUX_ARM) github.com/netfoundry/ziti-cmd/ziti-controller/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ gox ${BUILDFLAGS_COMMON} -os="windows" -arch=amd64 $(BUILDFLAGS_WINDOWS_AMD64) github.com/netfoundry/ziti-cmd/ziti-controller/...

ziti-enroller-common:
	$(info ============ ziti-enroller-common starting ============)
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=/opt/osxcross/target/bin/o64-clang CXX=/opt/osxcross/target/bin/o64-clang++ gox ${BUILDFLAGS_COMMON} -os="darwin" -arch=amd64 $(BUILDFLAGS_DARWIN_AMD64) github.com/netfoundry/ziti-cmd/ziti-enroller/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) gox ${BUILDFLAGS_COMMON} -os="linux" -arch=amd64 $(BUILDFLAGS_LINUX_AMD64) github.com/netfoundry/ziti-cmd/ziti-enroller/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=arm-linux-gnueabihf-gcc gox ${BUILDFLAGS_COMMON} -os="linux" -arch=arm $(BUILDFLAGS_LINUX_ARM) github.com/netfoundry/ziti-cmd/ziti-enroller/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ gox ${BUILDFLAGS_COMMON} -os="windows" -arch=amd64 $(BUILDFLAGS_WINDOWS_AMD64) github.com/netfoundry/ziti-cmd/ziti-enroller/...

ziti-fabric-common:
	$(info ============ ziti-fabric-common starting ============)
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=/opt/osxcross/target/bin/o64-clang CXX=/opt/osxcross/target/bin/o64-clang++ gox ${BUILDFLAGS_COMMON} -os="darwin" -arch=amd64 $(BUILDFLAGS_DARWIN_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) gox ${BUILDFLAGS_COMMON} -os="linux" -arch=amd64 $(BUILDFLAGS_LINUX_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=arm-linux-gnueabihf-gcc gox ${BUILDFLAGS_COMMON} -os="linux" -arch=arm $(BUILDFLAGS_LINUX_ARM) github.com/netfoundry/ziti-cmd/ziti-fabric/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ gox ${BUILDFLAGS_COMMON} -os="windows" -arch=amd64 $(BUILDFLAGS_WINDOWS_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric/...

ziti-fabric-gw-common:
	$(info ============ ziti-fabric-gw-common starting ============)
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=/opt/osxcross/target/bin/o64-clang CXX=/opt/osxcross/target/bin/o64-clang++ gox ${BUILDFLAGS_COMMON} -os="darwin" -arch=amd64 $(BUILDFLAGS_DARWIN_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric-gw/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) gox ${BUILDFLAGS_COMMON} -os="linux" -arch=amd64 $(BUILDFLAGS_LINUX_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric-gw/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=arm-linux-gnueabihf-gcc gox ${BUILDFLAGS_COMMON} -os="linux" -arch=arm $(BUILDFLAGS_LINUX_ARM) github.com/netfoundry/ziti-cmd/ziti-fabric-gw/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ gox ${BUILDFLAGS_COMMON} -os="windows" -arch=amd64 $(BUILDFLAGS_WINDOWS_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric-gw/...

ziti-fabric-test-common:
	$(info ============ ziti-fabric-test-common starting ============)
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=/opt/osxcross/target/bin/o64-clang CXX=/opt/osxcross/target/bin/o64-clang++ gox ${BUILDFLAGS_COMMON} -os="darwin" -arch=amd64 $(BUILDFLAGS_DARWIN_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric-test/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) gox ${BUILDFLAGS_COMMON} -os="linux" -arch=amd64 $(BUILDFLAGS_LINUX_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric-test/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=arm-linux-gnueabihf-gcc gox ${BUILDFLAGS_COMMON} -os="linux" -arch=arm $(BUILDFLAGS_LINUX_ARM) github.com/netfoundry/ziti-cmd/ziti-fabric-test/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ gox ${BUILDFLAGS_COMMON} -os="windows" -arch=amd64 $(BUILDFLAGS_WINDOWS_AMD64) github.com/netfoundry/ziti-cmd/ziti-fabric-test/...

ziti-router-common:
	$(info ============ ziti-router-common starting ============)
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=/opt/osxcross/target/bin/o64-clang CXX=/opt/osxcross/target/bin/o64-clang++ gox ${BUILDFLAGS_COMMON} -os="darwin" -arch=amd64 $(BUILDFLAGS_DARWIN_AMD64) github.com/netfoundry/ziti-cmd/ziti-router/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) gox ${BUILDFLAGS_COMMON} -os="linux" -arch=amd64 $(BUILDFLAGS_LINUX_AMD64) github.com/netfoundry/ziti-cmd/ziti-router/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=arm-linux-gnueabihf-gcc gox ${BUILDFLAGS_COMMON} -os="linux" -arch=arm $(BUILDFLAGS_LINUX_ARM) github.com/netfoundry/ziti-cmd/ziti-router/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ gox ${BUILDFLAGS_COMMON} -os="windows" -arch=amd64 $(BUILDFLAGS_WINDOWS_AMD64) github.com/netfoundry/ziti-cmd/ziti-router/...

ziti-tunnel-common:
	$(info ============ ziti-tunnel-common starting ============)
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=/opt/osxcross/target/bin/o64-clang CXX=/opt/osxcross/target/bin/o64-clang++ gox ${BUILDFLAGS_COMMON} -os="darwin" -arch=amd64 $(BUILDFLAGS_DARWIN_AMD64) github.com/netfoundry/ziti-cmd/ziti-tunnel/cmd/ziti-tunnel/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) gox ${BUILDFLAGS_COMMON} -os="linux" -arch=amd64 $(BUILDFLAGS_LINUX_AMD64) github.com/netfoundry/ziti-cmd/ziti-tunnel/cmd/ziti-tunnel/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=arm-linux-gnueabihf-gcc gox ${BUILDFLAGS_COMMON} -os="linux" -arch=arm $(BUILDFLAGS_LINUX_ARM) github.com/netfoundry/ziti-cmd/ziti-tunnel/cmd/ziti-tunnel/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ gox ${BUILDFLAGS_COMMON} -os="windows" -arch=amd64 $(BUILDFLAGS_WINDOWS_AMD64) github.com/netfoundry/ziti-cmd/ziti-tunnel/cmd/ziti-tunnel/...

ziti-cli-common:
	$(info ============ ziti-cli-common starting ============)
	cd release; pwd; ls; CGO_ENABLED=$(CGO_ENABLED) CC=/opt/osxcross/target/bin/o64-clang CXX=/opt/osxcross/target/bin/o64-clang++ gox ${BUILDFLAGS_COMMON} -os="darwin" -arch=amd64 $(BUILDFLAGS_DARWIN_AMD64) github.com/netfoundry/ziti-cmd/ziti/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) gox ${BUILDFLAGS_COMMON} -os="linux" -arch=amd64 $(BUILDFLAGS_LINUX_AMD64) github.com/netfoundry/ziti-cmd/ziti/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=arm-linux-gnueabihf-gcc gox ${BUILDFLAGS_COMMON} -os="linux" -arch=arm $(BUILDFLAGS_LINUX_ARM) github.com/netfoundry/ziti-cmd/ziti/...
	cd release; CGO_ENABLED=$(CGO_ENABLED) CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ gox ${BUILDFLAGS_COMMON} -os="windows" -arch=amd64 $(BUILDFLAGS_WINDOWS_AMD64) github.com/netfoundry/ziti-cmd/ziti/...

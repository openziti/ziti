...
lists identity-role-attributes managed by the Ziti Edge Controller

```
ziti edge list identity-role-attributes <filter>? [flags]
```
...
```
  ...
  -h, --help                  help for identity-role-attributes

## ziti edge list service edge-routers

lists edge-routers related to a services instanced managed by the Ziti Edge Controller
...
```
ziti edge list service edge-routers <id or name> [flags]
```

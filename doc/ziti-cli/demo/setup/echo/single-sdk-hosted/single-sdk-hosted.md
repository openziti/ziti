...
Walks you through hosting configuration for an echo service hosted by a single sdk application

```
ziti demo setup echo single-sdk-hosted [flags]
```
...
```
  ...
  -h, --help                     help for single-sdk-hosted

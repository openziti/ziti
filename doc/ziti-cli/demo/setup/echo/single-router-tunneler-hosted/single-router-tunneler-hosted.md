...
Walks you through hosting configuration for a simple echo service, hosted by a single router-embedded tunneler

```
ziti demo setup echo single-router-tunneler-hosted [flags]
```
...
```
  ...
  -h, --help                     help for single-router-tunneler-hosted

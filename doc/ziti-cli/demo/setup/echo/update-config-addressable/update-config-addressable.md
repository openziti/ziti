...
Updates the echo service hosting configuration to allow addressing the individual servers

```
ziti demo setup echo update-config-addressable [flags]
```
...
```
  ...
  -h, --help                     help for update-config-addressable

...
Sets the global logrus logging level in the target application

```
ziti demo agent set-log-level log-level (panic, fatal, error, warn, info, debug, trace) [flags]
```

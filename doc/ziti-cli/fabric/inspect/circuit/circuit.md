## ziti fabric inspect circuit

query routers to get diagnostic information for a circuit

```
ziti fabric inspect circuit [flags]
```
...
```
  ...
  -h, --help                  help for circuit
      --include-stacks        Include stack information

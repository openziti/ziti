...
# Set the AWS access key and secret key from environment variables  - must run 'sudo apt-get update -y; sudo apt install awscli; sudo aws configure' and enter your keys, etc.

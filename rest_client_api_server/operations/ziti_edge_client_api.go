...
func NewZitiEdgeClientAPI(spec *loads.Document) *ZitiEdgeClientAPI {
	return &ZitiEdgeClientAPI{
		...
		EnrollExtendRouterEnrollmentVerifyHandler: enroll.ExtendRouterEnrollmentVerifyHandlerFunc(func(params enroll.ExtendRouterEnrollmentVerifyParams) middleware.Responder {
			return middleware.NotImplemented("operation enroll.ExtendRouterEnrollmentVerify has not yet been implemented")
		}),
		EnrollExtendRouterEnrollmentWithVerifyHandler: enroll.ExtendRouterEnrollmentWithVerifyHandlerFunc(func(params enroll.ExtendRouterEnrollmentWithVerifyParams) middleware.Responder {
...
type ZitiEdgeClientAPI struct {
	...
	// EnrollExtendRouterEnrollmentVerifyHandler sets the operation handler for the extend router enrollment verify operation
	EnrollExtendRouterEnrollmentVerifyHandler enroll.ExtendRouterEnrollmentVerifyHandler
	// EnrollExtendRouterEnrollmentWithVerifyHandler sets the operation handler for the extend router enrollment with verify operation
	EnrollExtendRouterEnrollmentWithVerifyHandler enroll.ExtendRouterEnrollmentWithVerifyHandler
...
func (o *ZitiEdgeClientAPI) Validate() error {
	...
	if o.EnrollExtendRouterEnrollmentVerifyHandler == nil {
		unregistered = append(unregistered, "enroll.ExtendRouterEnrollmentVerifyHandler")
	}
	if o.EnrollExtendRouterEnrollmentWithVerifyHandler == nil {
		unregistered = append(unregistered, "enroll.ExtendRouterEnrollmentWithVerifyHandler")
	}
...
func (o *ZitiEdgeClientAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/enroll/extend/router-verify'"] = enroll.NewExtendRouterEnrollmentVerify(o.context, o.EnrollExtendRouterEnrollmentVerifyHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/enroll/extend/router-with-verify"] = enroll.NewExtendRouterEnrollmentWithVerify(o.context, o.EnrollExtendRouterEnrollmentWithVerifyHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}

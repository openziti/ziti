...
func (o *EnrollOttParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *EnrollOttParams) validateToken(formats strfmt.Registry) error {

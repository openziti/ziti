...
type GetIdentityFailedServiceRequestsOK struct {
	...
	/*
	  In: Body
	*/
	Payload *rest_model.GetIdentityFailedServiceRequestEnvelope `json:"body,omitempty"`
}
...
func (o *GetIdentityFailedServiceRequestsOK) WithPayload(payload *rest_model.GetIdentityFailedServiceRequestEnvelope) *GetIdentityFailedServiceRequestsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get identity failed service requests o k response
func (o *GetIdentityFailedServiceRequestsOK) SetPayload(payload *rest_model.GetIdentityFailedServiceRequestEnvelope) {
	o.Payload = payload
}

...
func (o *CheckDataIntegrityParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	qFixErrors, qhkFixErrors, _ := qs.GetOK("fixErrors")
	if err := o.bindFixErrors(qFixErrors, qhkFixErrors, route.Formats); err != nil {
		res = append(res, err)
	}
...
// bindFixErrors binds and validates parameter FixErrors from query.
func (o *CheckDataIntegrityParams) bindFixErrors(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if err != nil {
		return errors.InvalidType("fixErrors", "query", "bool", raw)
	}
	o.FixErrors = &value

...
import (
	...
	"github.com/netfoundry/ziti-fabric/fabric/ctrl_msg"
...
func (h *sessionRequestHandler) HandleReceive(msg *channel2.Message, ch channel2.Channel) {
	...
	if err := proto.Unmarshal(msg.Body, request); err == nil {
		 ...
		 */
		go func() {
			if session, err := h.network.CreateSession(h.r, &identity.TokenId{Token: request.IngressId}, request.ServiceId); err == nil {

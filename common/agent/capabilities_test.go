...
func TestAgentCapabilityActivation(t *testing.T) {
	resetCaps()
	markAgentCapabilityActive(AgentLoggingSlogLevels)
...
func TestAgentCapabilityBitFromString(t *testing.T) {
	...
	require.True(t, ok)
	require.Equal(t, AgentLoggingSlogLevels, bit)
...
func TestRegisterAppCapabilitiesPanicsAfterFreeze(t *testing.T) {
	resetCaps()
	freezeCapabilities()

...
// Enabled returns true. AsyncHandler does no level gating itself; downstream
// handlers (or callers) decide what to filter. This keeps Handle on the
// hot-path of every slog call without an extra atomic load.

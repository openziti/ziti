...
//
// prettyOpts defaults to DefaultPrettyOptions(out): pfxlog-compatible labels,
// "github.com/openziti/" trimmed from function names, relative time since the
// start of today, and color keyed on out being a terminal (overridable via
// PFXLOG_USE_COLOR). out defaults to os.Stderr.

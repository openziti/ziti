...
func (x *UpdateServiceConfigsCmd_ServiceConfig) Reset() {
	*x = UpdateServiceConfigsCmd_ServiceConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_edge_cmd_proto_msgTypes[74]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_edge_cmd_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x63, 0x74, 0x78, 0x22, 0xd9, 0x01, 0x0a, 0x23, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x57, 0x69, 0x74, 0x68, 0x41, 0x75, 0x74, 0x68,
	0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x43, 0x6d, 0x64, 0x12, 0x36, 0x0a,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x47, 0x0a, 0x0e, 0x61, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74,
	0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e,
	0x7a, 0x69, 0x74, 0x69, 0x2e, 0x65, 0x64, 0x67, 0x65, 0x5f, 0x63, 0x6d, 0x64, 0x2e, 0x70, 0x62,
	0x2e, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x0e,
	0x61, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x12, 0x31,
	...
	0x08, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x49, 0x64, 0x2a, 0xab, 0x02, 0x0a, 0x0b, 0x43, 0x6f,
	...
	0x54, 0x79, 0x70, 0x65, 0x10, 0xef, 0x07, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_edge_cmd_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_edge_cmd_proto_goTypes = []interface{}{
	...
	(*CreateIdentityWithAuthenticatorsCmd)(nil),   // 24: ziti.edge_cmd.pb.CreateIdentityWithAuthenticatorsCmd
	(*Mfa)(nil),                                   // 25: ziti.edge_cmd.pb.Mfa
	...
	(*PostureCheck_Mac)(nil),                      // 62: ziti.edge_cmd.pb.PostureCheck.Mac
	(*PostureCheck_Mfa)(nil),                      // 63: ziti.edge_cmd.pb.PostureCheck.Mfa
	(*PostureCheck_Os)(nil),                       // 64: ziti.edge_cmd.pb.PostureCheck.Os
	(*PostureCheck_OsList)(nil),                   // 65: ziti.edge_cmd.pb.PostureCheck.OsList
	(*PostureCheck_Process)(nil),                  // 66: ziti.edge_cmd.pb.PostureCheck.Process
	(*PostureCheck_ProcessMulti)(nil),             // 67: ziti.edge_cmd.pb.PostureCheck.ProcessMulti
	(*PostureCheck_Domains)(nil),                  // 68: ziti.edge_cmd.pb.PostureCheck.Domains
	nil,                                           // 69: ziti.edge_cmd.pb.PostureCheck.TagsEntry
	nil,                                           // 70: ziti.edge_cmd.pb.Revocation.TagsEntry
	nil,                                           // 71: ziti.edge_cmd.pb.Service.TagsEntry
	nil,                                           // 72: ziti.edge_cmd.pb.ServiceEdgeRouterPolicy.TagsEntry
	nil,                                           // 73: ziti.edge_cmd.pb.ServicePolicy.TagsEntry
	nil,                                           // 74: ziti.edge_cmd.pb.TransitRouter.TagsEntry
	(*UpdateServiceConfigsCmd_ServiceConfig)(nil), // 75: ziti.edge_cmd.pb.UpdateServiceConfigsCmd.ServiceConfig
...
var file_edge_cmd_proto_depIdxs = []int32{
	...
	76, // 16: ziti.edge_cmd.pb.Controller.lastJoinedAt:type_name -> google.protobuf.Timestamp
	...
	76, // 27: ziti.edge_cmd.pb.Enrollment.issuedAt:type_name -> google.protobuf.Timestamp
	76, // 28: ziti.edge_cmd.pb.Enrollment.expiresAt:type_name -> google.protobuf.Timestamp
	...
	76, // 32: ziti.edge_cmd.pb.ExternalJwtSigner.notAfter:type_name -> google.protobuf.Timestamp
	76, // 33: ziti.edge_cmd.pb.ExternalJwtSigner.notBefore:type_name -> google.protobuf.Timestamp
	...
	76, // 39: ziti.edge_cmd.pb.Identity.disabledAt:type_name -> google.protobuf.Timestamp
	76, // 40: ziti.edge_cmd.pb.Identity.disabledUntil:type_name -> google.protobuf.Timestamp
	...
	22, // 45: ziti.edge_cmd.pb.CreateIdentityWithAuthenticatorsCmd.identity:type_name -> ziti.edge_cmd.pb.Identity
	7,  // 46: ziti.edge_cmd.pb.CreateIdentityWithAuthenticatorsCmd.authenticators:type_name -> ziti.edge_cmd.pb.Authenticator
	1,  // 47: ziti.edge_cmd.pb.CreateIdentityWithAuthenticatorsCmd.ctx:type_name -> ziti.edge_cmd.pb.ChangeContext
	61, // 48: ziti.edge_cmd.pb.Mfa.tags:type_name -> ziti.edge_cmd.pb.Mfa.TagsEntry
	69, // 49: ziti.edge_cmd.pb.PostureCheck.tags:type_name -> ziti.edge_cmd.pb.PostureCheck.TagsEntry
	62, // 50: ziti.edge_cmd.pb.PostureCheck.mac:type_name -> ziti.edge_cmd.pb.PostureCheck.Mac
	63, // 51: ziti.edge_cmd.pb.PostureCheck.mfa:type_name -> ziti.edge_cmd.pb.PostureCheck.Mfa
	65, // 52: ziti.edge_cmd.pb.PostureCheck.osList:type_name -> ziti.edge_cmd.pb.PostureCheck.OsList
	66, // 53: ziti.edge_cmd.pb.PostureCheck.process:type_name -> ziti.edge_cmd.pb.PostureCheck.Process
	67, // 54: ziti.edge_cmd.pb.PostureCheck.processMulti:type_name -> ziti.edge_cmd.pb.PostureCheck.ProcessMulti
	68, // 55: ziti.edge_cmd.pb.PostureCheck.domains:type_name -> ziti.edge_cmd.pb.PostureCheck.Domains
	76, // 56: ziti.edge_cmd.pb.Revocation.expiresAt:type_name -> google.protobuf.Timestamp
	70, // 57: ziti.edge_cmd.pb.Revocation.tags:type_name -> ziti.edge_cmd.pb.Revocation.TagsEntry
	71, // 58: ziti.edge_cmd.pb.Service.tags:type_name -> ziti.edge_cmd.pb.Service.TagsEntry
	72, // 59: ziti.edge_cmd.pb.ServiceEdgeRouterPolicy.tags:type_name -> ziti.edge_cmd.pb.ServiceEdgeRouterPolicy.TagsEntry
	73, // 60: ziti.edge_cmd.pb.ServicePolicy.tags:type_name -> ziti.edge_cmd.pb.ServicePolicy.TagsEntry
	74, // 61: ziti.edge_cmd.pb.TransitRouter.tags:type_name -> ziti.edge_cmd.pb.TransitRouter.TagsEntry
	31, // 62: ziti.edge_cmd.pb.CreateTransitRouterCmd.router:type_name -> ziti.edge_cmd.pb.TransitRouter
	19, // 63: ziti.edge_cmd.pb.CreateTransitRouterCmd.enrollment:type_name -> ziti.edge_cmd.pb.Enrollment
	1,  // 64: ziti.edge_cmd.pb.CreateTransitRouterCmd.ctx:type_name -> ziti.edge_cmd.pb.ChangeContext
	75, // 65: ziti.edge_cmd.pb.UpdateServiceConfigsCmd.serviceConfigs:type_name -> ziti.edge_cmd.pb.UpdateServiceConfigsCmd.ServiceConfig
	1,  // 66: ziti.edge_cmd.pb.UpdateServiceConfigsCmd.ctx:type_name -> ziti.edge_cmd.pb.ChangeContext
	6,  // 67: ziti.edge_cmd.pb.JsonMap.ValueEntry.value:type_name -> ziti.edge_cmd.pb.JsonValue
	76, // 68: ziti.edge_cmd.pb.Authenticator.Cert.extendRequestedAt:type_name -> google.protobuf.Timestamp
	3,  // 69: ziti.edge_cmd.pb.Authenticator.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	42, // 70: ziti.edge_cmd.pb.AuthPolicy.Primary.cert:type_name -> ziti.edge_cmd.pb.AuthPolicy.Primary.Cert
	43, // 71: ziti.edge_cmd.pb.AuthPolicy.Primary.updb:type_name -> ziti.edge_cmd.pb.AuthPolicy.Primary.Updb
	44, // 72: ziti.edge_cmd.pb.AuthPolicy.Primary.extJwt:type_name -> ziti.edge_cmd.pb.AuthPolicy.Primary.ExtJwt
	3,  // 73: ziti.edge_cmd.pb.AuthPolicy.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 74: ziti.edge_cmd.pb.Ca.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 75: ziti.edge_cmd.pb.Config.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 76: ziti.edge_cmd.pb.ConfigType.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 77: ziti.edge_cmd.pb.Controller.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	13, // 78: ziti.edge_cmd.pb.Controller.ApiAddressesEntry.value:type_name -> ziti.edge_cmd.pb.ApiAddressList
	3,  // 79: ziti.edge_cmd.pb.EdgeRouter.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 80: ziti.edge_cmd.pb.EdgeRouterPolicy.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 81: ziti.edge_cmd.pb.Enrollment.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 82: ziti.edge_cmd.pb.ExternalJwtSigner.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 83: ziti.edge_cmd.pb.Identity.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 84: ziti.edge_cmd.pb.Mfa.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	64, // 85: ziti.edge_cmd.pb.PostureCheck.OsList.osList:type_name -> ziti.edge_cmd.pb.PostureCheck.Os
	66, // 86: ziti.edge_cmd.pb.PostureCheck.ProcessMulti.processes:type_name -> ziti.edge_cmd.pb.PostureCheck.Process
	3,  // 87: ziti.edge_cmd.pb.PostureCheck.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 88: ziti.edge_cmd.pb.Revocation.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 89: ziti.edge_cmd.pb.Service.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 90: ziti.edge_cmd.pb.ServiceEdgeRouterPolicy.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 91: ziti.edge_cmd.pb.ServicePolicy.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	3,  // 92: ziti.edge_cmd.pb.TransitRouter.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
...
func file_edge_cmd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_edge_cmd_proto_msgTypes[74].Exporter = func(v interface{}, i int) interface{} {

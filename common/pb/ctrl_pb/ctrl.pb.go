...
// FaultReason explains why a Fault was emitted. Numbering is load-bearing: the proto3 zero
// value (what an absent field or an old router that does not stamp it decodes to) MUST be a
// teardown reason, never the Limbo-eligible one. Only ChannelClosed is Limbo-eligible.
type FaultReason int32

const (
	FaultReason_ReasonUnspecified FaultReason = 0
	// ChannelClosed: the SDK's edge channel dropped (transport loss); the only reason eligible
	// for a Limbo hold and SDK-driven reroute.
	FaultReason_ChannelClosed FaultReason = 1
	// XgClose: the SDK explicitly closed the connection; a normal close, not resurrectable.
	FaultReason_XgClose FaultReason = 2
	// AccessLoss: policy/RDM revoked the identity's access; the circuit must not be resurrectable.
	FaultReason_AccessLoss FaultReason = 3
)

// Enum value maps for FaultReason.
var (
	FaultReason_name = map[int32]string{
		0: "ReasonUnspecified",
		1: "ChannelClosed",
		2: "XgClose",
		3: "AccessLoss",
	}
	FaultReason_value = map[string]int32{
		"ReasonUnspecified": 0,
		"ChannelClosed":     1,
		"XgClose":           2,
		"AccessLoss":        3,
...
func (x FaultReason) Enum() *FaultReason {
	p := new(FaultReason)
	*p = x
	return p
}

func (x FaultReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FaultReason) Descriptor() protoreflect.EnumDescriptor {
	return file_ctrl_proto_enumTypes[7].Descriptor()
}

func (FaultReason) Type() protoreflect.EnumType {
	return &file_ctrl_proto_enumTypes[7]
}

func (x FaultReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FaultReason.Descriptor instead.
func (FaultReason) EnumDescriptor() ([]byte, []int) {
...
type Fault struct {
	...
	Reason        FaultReason            `protobuf:"varint,4,opt,name=reason,proto3,enum=ziti.ctrl.pb.FaultReason" json:"reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Fault) GetReason() FaultReason {
	if x != nil {
		return x.Reason
	}
	return FaultReason_ReasonUnspecified
}
...
const file_ctrl_proto_rawDesc = "" +
	...
	"\tconnState\x18\a \x01(\v2\x1b.ziti.ctrl.pb.LinkConnStateR\tconnState\"\x9e\x01\n" +
	"\x05Fault\x124\n" +
	"\asubject\x18\x01 \x01(\x0e2\x1a.ziti.ctrl.pb.FaultSubjectR\asubject\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1c\n" +
	"\titeration\x18\x03 \x01(\rR\titeration\x121\n" +
	"\x06reason\x18\x04 \x01(\x0e2\x19.ziti.ctrl.pb.FaultReasonR\x06reason\"\xa1\x01\n" +
	"\aContext\x129\n" +
	...
	"\tlisteners\x18\x01 \x03(\v2\x1e.ziti.ctrl.pb.CtrlChanListenerR\tlisteners*\xdb\x06\n" +
	"\vContentType\x12\b\n" +
	...
	"\x15RequestClusterMembers\x10\x9f\b*\x88\x01\n" +
	...
	"\rLinkDuplicate\x10\x05*T\n" +
	"\vFaultReason\x12\x15\n" +
	"\x11ReasonUnspecified\x10\x00\x12\x11\n" +
	"\rChannelClosed\x10\x01\x12\v\n" +
	"\aXgClose\x10\x02\x12\x0e\n" +
	"\n" +
	"AccessLoss\x10\x03*(\n" +
	"\bDestType\x12\t\n" +
...
var file_ctrl_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
...
var file_ctrl_proto_goTypes = []any{
	...
	(FaultReason)(0),                      // 7: ziti.ctrl.pb.FaultReason
	(DestType)(0),                         // 8: ziti.ctrl.pb.DestType
	(PeerState)(0),                        // 9: ziti.ctrl.pb.PeerState
	(*Settings)(nil),                      // 10: ziti.ctrl.pb.Settings
	(*CircuitRequest)(nil),                // 11: ziti.ctrl.pb.CircuitRequest
	(*CircuitConfirmation)(nil),           // 12: ziti.ctrl.pb.CircuitConfirmation
	(*CreateTerminatorRequest)(nil),       // 13: ziti.ctrl.pb.CreateTerminatorRequest
	(*RemoveTerminatorRequest)(nil),       // 14: ziti.ctrl.pb.RemoveTerminatorRequest
	(*RemoveTerminatorsRequest)(nil),      // 15: ziti.ctrl.pb.RemoveTerminatorsRequest
	(*Terminator)(nil),                    // 16: ziti.ctrl.pb.Terminator
	(*ValidateTerminatorsRequest)(nil),    // 17: ziti.ctrl.pb.ValidateTerminatorsRequest
	(*ValidateTerminatorsV2Request)(nil),  // 18: ziti.ctrl.pb.ValidateTerminatorsV2Request
	(*RouterTerminatorState)(nil),         // 19: ziti.ctrl.pb.RouterTerminatorState
	(*ValidateTerminatorsV2Response)(nil), // 20: ziti.ctrl.pb.ValidateTerminatorsV2Response
	(*UpdateTerminatorRequest)(nil),       // 21: ziti.ctrl.pb.UpdateTerminatorRequest
...
var file_ctrl_proto_depIdxs = []int32{
	...
	16, // 5: ziti.ctrl.pb.ValidateTerminatorsRequest.terminators:type_name -> ziti.ctrl.pb.Terminator
	16, // 6: ziti.ctrl.pb.ValidateTerminatorsV2Request.terminators:type_name -> ziti.ctrl.pb.Terminator
	...
	7,  // 13: ziti.ctrl.pb.Fault.reason:type_name -> ziti.ctrl.pb.FaultReason
	54, // 14: ziti.ctrl.pb.Context.fields:type_name -> ziti.ctrl.pb.Context.FieldsEntry
	55, // 15: ziti.ctrl.pb.Route.egress:type_name -> ziti.ctrl.pb.Route.Egress
	56, // 16: ziti.ctrl.pb.Route.forwards:type_name -> ziti.ctrl.pb.Route.Forward
	26, // 17: ziti.ctrl.pb.Route.context:type_name -> ziti.ctrl.pb.Context
	57, // 18: ziti.ctrl.pb.Route.tags:type_name -> ziti.ctrl.pb.Route.TagsEntry
	59, // 19: ziti.ctrl.pb.InspectResponse.values:type_name -> ziti.ctrl.pb.InspectResponse.InspectValue
	32, // 20: ziti.ctrl.pb.Listeners.listeners:type_name -> ziti.ctrl.pb.Listener
	34, // 21: ziti.ctrl.pb.CtrlDetail.endpoints:type_name -> ziti.ctrl.pb.CtrlEndpoint
	35, // 22: ziti.ctrl.pb.UpdateCtrlAddresses.controllers:type_name -> ziti.ctrl.pb.CtrlDetail
	9,  // 23: ziti.ctrl.pb.PeerStateChange.state:type_name -> ziti.ctrl.pb.PeerState
	32, // 24: ziti.ctrl.pb.PeerStateChange.listeners:type_name -> ziti.ctrl.pb.Listener
	38, // 25: ziti.ctrl.pb.PeerStateChanges.changes:type_name -> ziti.ctrl.pb.PeerStateChange
	2,  // 26: ziti.ctrl.pb.RouterMetadata.capabilities:type_name -> ziti.ctrl.pb.RouterCapability
	41, // 27: ziti.ctrl.pb.RouterInterfacesUpdate.interfaces:type_name -> ziti.ctrl.pb.Interface
	23, // 28: ziti.ctrl.pb.LinkStateUpdate.connState:type_name -> ziti.ctrl.pb.LinkConnState
	60, // 29: ziti.ctrl.pb.Alert.relatedEntities:type_name -> ziti.ctrl.pb.Alert.RelatedEntitiesEntry
	44, // 30: ziti.ctrl.pb.Alerts.alerts:type_name -> ziti.ctrl.pb.Alert
	46, // 31: ziti.ctrl.pb.CtrlChanListeners.listeners:type_name -> ziti.ctrl.pb.CtrlChanListener
	19, // 32: ziti.ctrl.pb.ValidateTerminatorsV2Response.StatesEntry.value:type_name -> ziti.ctrl.pb.RouterTerminatorState
	23, // 33: ziti.ctrl.pb.RouterLinks.RouterLink.connState:type_name -> ziti.ctrl.pb.LinkConnState
	58, // 34: ziti.ctrl.pb.Route.Egress.peerData:type_name -> ziti.ctrl.pb.Route.Egress.PeerDataEntry
	8,  // 35: ziti.ctrl.pb.Route.Forward.dstType:type_name -> ziti.ctrl.pb.DestType

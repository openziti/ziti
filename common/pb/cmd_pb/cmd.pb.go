...
type Router struct {
	...
	CtrlChanListeners map[string]*CtrlChanListenerDetail `protobuf:"bytes,9,rep,name=ctrlChanListeners,proto3" json:"ctrlChanListeners,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

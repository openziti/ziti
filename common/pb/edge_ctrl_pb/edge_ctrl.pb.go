...
var file_edge_ctrl_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x85, 0x01, 0x0a, 0x17, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x54,
	...
	0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x64, 0x22, 0xae, 0x02, 0x0a,
	...
	0x08, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x73, 0x74, 0x22, 0xa2, 0x01,
	...
	0x65, 0x64, 0x22, 0x3f, 0x0a, 0x17, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65,
	...
	0x65, 0x6e, 0x73, 0x22, 0x69, 0x0a, 0x07, 0x45, 0x6e, 0x76, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x4f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xa1,
	...
	0x09, 0x73, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xec, 0x01, 0x0a, 0x1d, 0x55,
	...
	0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x65, 0x72, 0x74, 0x50, 0x65, 0x6d, 0x2a, 0xe4,
	...
	0x10, 0xf6, 0x9d, 0x01, 0x12, 0x1a, 0x0a, 0x14, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x43,
	0x65, 0x72, 0x74, 0x41, 0x64, 0x64, 0x65, 0x64, 0x54, 0x79, 0x70, 0x65, 0x10, 0xf7, 0x9d, 0x01,
	...
	0x65, 0x10, 0xbc, 0x9f, 0x01, 0x2a, 0x21, 0x0a, 0x0b, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x73, 0x73, 0x65, 0x64, 0x10, 0xff, 0x07, 0x2a, 0x2e, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x54, 0x79, 0x70, 0x65, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x10, 0x00, 0x12, 0x0a,
	0x0a, 0x06, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x65,
	0x70, 0x6c, 0x61, 0x63, 0x65, 0x10, 0x02, 0x2a, 0x3d, 0x0a, 0x14, 0x54, 0x65, 0x72, 0x6d, 0x69,
	...
	0x69, 0x6c, 0x65, 0x64, 0x10, 0x02, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_edge_ctrl_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_edge_ctrl_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
var file_edge_ctrl_proto_goTypes = []interface{}{
	...
	(*ServerHello)(nil),                         // 5: ziti.edge_ctrl.pb.ServerHello
	(*Address)(nil),                             // 6: ziti.edge_ctrl.pb.Address
	(*Listener)(nil),                            // 7: ziti.edge_ctrl.pb.Listener
	(*ClientHello)(nil),                         // 8: ziti.edge_ctrl.pb.ClientHello
	(*Error)(nil),                               // 9: ziti.edge_ctrl.pb.Error
	(*Service)(nil),                             // 10: ziti.edge_ctrl.pb.Service
	(*Config)(nil),                              // 11: ziti.edge_ctrl.pb.Config
	(*SignerCerts)(nil),                         // 12: ziti.edge_ctrl.pb.SignerCerts
	(*Identity)(nil),                            // 13: ziti.edge_ctrl.pb.Identity
	(*PostureSet)(nil),                          // 14: ziti.edge_ctrl.pb.PostureSet
	(*PostureCheck)(nil),                        // 15: ziti.edge_ctrl.pb.PostureCheck
	...
	(*RemoveTerminatorRequest)(nil),             // 27: ziti.edge_ctrl.pb.RemoveTerminatorRequest
	(*UpdateTerminatorRequest)(nil),             // 28: ziti.edge_ctrl.pb.UpdateTerminatorRequest
	(*HealthEventRequest)(nil),                  // 29: ziti.edge_ctrl.pb.HealthEventRequest
	(*ValidateSessionsRequest)(nil),             // 30: ziti.edge_ctrl.pb.ValidateSessionsRequest
	(*EnvInfo)(nil),                             // 31: ziti.edge_ctrl.pb.EnvInfo
	(*SdkInfo)(nil),                             // 32: ziti.edge_ctrl.pb.SdkInfo
	(*CreateApiSessionRequest)(nil),             // 33: ziti.edge_ctrl.pb.CreateApiSessionRequest
	(*CreateApiSessionResponse)(nil),            // 34: ziti.edge_ctrl.pb.CreateApiSessionResponse
	(*CreateCircuitForServiceRequest)(nil),      // 35: ziti.edge_ctrl.pb.CreateCircuitForServiceRequest
	(*CreateSessionResponse)(nil),               // 36: ziti.edge_ctrl.pb.CreateSessionResponse
	(*CreateCircuitForServiceResponse)(nil),     // 37: ziti.edge_ctrl.pb.CreateCircuitForServiceResponse
	(*ServicesList)(nil),                        // 38: ziti.edge_ctrl.pb.ServicesList
	(*TunnelService)(nil),                       // 39: ziti.edge_ctrl.pb.TunnelService
	(*CreateTunnelTerminatorRequest)(nil),       // 40: ziti.edge_ctrl.pb.CreateTunnelTerminatorRequest
	(*CreateTunnelTerminatorResponse)(nil),      // 41: ziti.edge_ctrl.pb.CreateTunnelTerminatorResponse
	(*UpdateTunnelTerminatorRequest)(nil),       // 42: ziti.edge_ctrl.pb.UpdateTunnelTerminatorRequest
	(*EnrollmentExtendRouterRequest)(nil),       // 43: ziti.edge_ctrl.pb.EnrollmentExtendRouterRequest
	(*EnrollmentCertsResponse)(nil),             // 44: ziti.edge_ctrl.pb.EnrollmentCertsResponse
	(*EnrollmentExtendRouterVerifyRequest)(nil), // 45: ziti.edge_ctrl.pb.EnrollmentExtendRouterVerifyRequest
	nil, // 46: ziti.edge_ctrl.pb.ServerHello.DataEntry
	nil, // 47: ziti.edge_ctrl.pb.ServerHello.ByteDataEntry
	nil, // 48: ziti.edge_ctrl.pb.ClientHello.DataEntry
	nil, // 49: ziti.edge_ctrl.pb.PostureCheck.DataEntry
	nil, // 50: ziti.edge_ctrl.pb.CreateCircuitRequest.PeerDataEntry
	nil, // 51: ziti.edge_ctrl.pb.CreateCircuitResponse.PeerDataEntry
	nil, // 52: ziti.edge_ctrl.pb.CreateCircuitResponse.TagsEntry
	nil, // 53: ziti.edge_ctrl.pb.CreateTerminatorRequest.PeerDataEntry
	nil, // 54: ziti.edge_ctrl.pb.CreateApiSessionResponse.ServicePrecedencesEntry
	nil, // 55: ziti.edge_ctrl.pb.CreateApiSessionResponse.ServiceCostsEntry
	nil, // 56: ziti.edge_ctrl.pb.CreateCircuitForServiceRequest.PeerDataEntry
	nil, // 57: ziti.edge_ctrl.pb.CreateCircuitForServiceResponse.PeerDataEntry
	nil, // 58: ziti.edge_ctrl.pb.CreateCircuitForServiceResponse.TagsEntry
	nil, // 59: ziti.edge_ctrl.pb.CreateTunnelTerminatorRequest.PeerDataEntry
}
var file_edge_ctrl_proto_depIdxs = []int32{
	46, // 0: ziti.edge_ctrl.pb.ServerHello.data:type_name -> ziti.edge_ctrl.pb.ServerHello.DataEntry
	47, // 1: ziti.edge_ctrl.pb.ServerHello.byteData:type_name -> ziti.edge_ctrl.pb.ServerHello.ByteDataEntry
	6,  // 2: ziti.edge_ctrl.pb.Listener.address:type_name -> ziti.edge_ctrl.pb.Address
	6,  // 3: ziti.edge_ctrl.pb.Listener.advertise:type_name -> ziti.edge_ctrl.pb.Address
	48, // 4: ziti.edge_ctrl.pb.ClientHello.data:type_name -> ziti.edge_ctrl.pb.ClientHello.DataEntry
	7,  // 5: ziti.edge_ctrl.pb.ClientHello.listeners:type_name -> ziti.edge_ctrl.pb.Listener
	3,  // 6: ziti.edge_ctrl.pb.Config.type:type_name -> ziti.edge_ctrl.pb.ConfigType
	13, // 7: ziti.edge_ctrl.pb.Config.identities:type_name -> ziti.edge_ctrl.pb.Identity
	10, // 8: ziti.edge_ctrl.pb.Config.services:type_name -> ziti.edge_ctrl.pb.Service
	14, // 9: ziti.edge_ctrl.pb.Config.postureSet:type_name -> ziti.edge_ctrl.pb.PostureSet
	15, // 10: ziti.edge_ctrl.pb.Config.postureChecks:type_name -> ziti.edge_ctrl.pb.PostureCheck
	49, // 11: ziti.edge_ctrl.pb.PostureCheck.data:type_name -> ziti.edge_ctrl.pb.PostureCheck.DataEntry
	1,  // 12: ziti.edge_ctrl.pb.Session.type:type_name -> ziti.edge_ctrl.pb.SessionType
	10, // 13: ziti.edge_ctrl.pb.Session.service:type_name -> ziti.edge_ctrl.pb.Service
	17, // 14: ziti.edge_ctrl.pb.ApiSessionAdded.apiSessions:type_name -> ziti.edge_ctrl.pb.ApiSession
	17, // 15: ziti.edge_ctrl.pb.ApiSessionUpdated.apiSessions:type_name -> ziti.edge_ctrl.pb.ApiSession
	50, // 16: ziti.edge_ctrl.pb.CreateCircuitRequest.peerData:type_name -> ziti.edge_ctrl.pb.CreateCircuitRequest.PeerDataEntry
	51, // 17: ziti.edge_ctrl.pb.CreateCircuitResponse.peerData:type_name -> ziti.edge_ctrl.pb.CreateCircuitResponse.PeerDataEntry
	52, // 18: ziti.edge_ctrl.pb.CreateCircuitResponse.tags:type_name -> ziti.edge_ctrl.pb.CreateCircuitResponse.TagsEntry
	53, // 19: ziti.edge_ctrl.pb.CreateTerminatorRequest.peerData:type_name -> ziti.edge_ctrl.pb.CreateTerminatorRequest.PeerDataEntry
	4,  // 20: ziti.edge_ctrl.pb.CreateTerminatorRequest.precedence:type_name -> ziti.edge_ctrl.pb.TerminatorPrecedence
	4,  // 21: ziti.edge_ctrl.pb.UpdateTerminatorRequest.precedence:type_name -> ziti.edge_ctrl.pb.TerminatorPrecedence
	31, // 22: ziti.edge_ctrl.pb.CreateApiSessionRequest.envInfo:type_name -> ziti.edge_ctrl.pb.EnvInfo
	32, // 23: ziti.edge_ctrl.pb.CreateApiSessionRequest.sdkInfo:type_name -> ziti.edge_ctrl.pb.SdkInfo
	4,  // 24: ziti.edge_ctrl.pb.CreateApiSessionResponse.defaultHostingPrecedence:type_name -> ziti.edge_ctrl.pb.TerminatorPrecedence
	54, // 25: ziti.edge_ctrl.pb.CreateApiSessionResponse.servicePrecedences:type_name -> ziti.edge_ctrl.pb.CreateApiSessionResponse.ServicePrecedencesEntry
	55, // 26: ziti.edge_ctrl.pb.CreateApiSessionResponse.serviceCosts:type_name -> ziti.edge_ctrl.pb.CreateApiSessionResponse.ServiceCostsEntry
	56, // 27: ziti.edge_ctrl.pb.CreateCircuitForServiceRequest.peerData:type_name -> ziti.edge_ctrl.pb.CreateCircuitForServiceRequest.PeerDataEntry
	34, // 28: ziti.edge_ctrl.pb.CreateCircuitForServiceResponse.apiSession:type_name -> ziti.edge_ctrl.pb.CreateApiSessionResponse
	36, // 29: ziti.edge_ctrl.pb.CreateCircuitForServiceResponse.session:type_name -> ziti.edge_ctrl.pb.CreateSessionResponse
	57, // 30: ziti.edge_ctrl.pb.CreateCircuitForServiceResponse.peerData:type_name -> ziti.edge_ctrl.pb.CreateCircuitForServiceResponse.PeerDataEntry
	58, // 31: ziti.edge_ctrl.pb.CreateCircuitForServiceResponse.tags:type_name -> ziti.edge_ctrl.pb.CreateCircuitForServiceResponse.TagsEntry
	39, // 32: ziti.edge_ctrl.pb.ServicesList.services:type_name -> ziti.edge_ctrl.pb.TunnelService
	59, // 33: ziti.edge_ctrl.pb.CreateTunnelTerminatorRequest.peerData:type_name -> ziti.edge_ctrl.pb.CreateTunnelTerminatorRequest.PeerDataEntry
	4,  // 34: ziti.edge_ctrl.pb.CreateTunnelTerminatorRequest.precedence:type_name -> ziti.edge_ctrl.pb.TerminatorPrecedence
	34, // 35: ziti.edge_ctrl.pb.CreateTunnelTerminatorResponse.apiSession:type_name -> ziti.edge_ctrl.pb.CreateApiSessionResponse
	36, // 36: ziti.edge_ctrl.pb.CreateTunnelTerminatorResponse.session:type_name -> ziti.edge_ctrl.pb.CreateSessionResponse
	4,  // 37: ziti.edge_ctrl.pb.UpdateTunnelTerminatorRequest.precedence:type_name -> ziti.edge_ctrl.pb.TerminatorPrecedence
	4,  // 38: ziti.edge_ctrl.pb.CreateApiSessionResponse.ServicePrecedencesEntry.value:type_name -> ziti.edge_ctrl.pb.TerminatorPrecedence

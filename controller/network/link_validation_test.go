...
// same state, so a differing conn count is a real disagreement. This is the case multi-underlay links make
// most likely and the one that went unreported, since the count check used to leave the link valid.

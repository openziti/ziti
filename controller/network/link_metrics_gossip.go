...
// initLinkMetricsGossip registers the link-metrics gossip state type. Called once from initGossip, which
// owns the store this registers against.
func (network *Network) initLinkMetricsGossip() {

...
func (o *CreateDatabaseSnapshotOK) Error() string {
	...
	return fmt.Sprintf("[POST /database][%d] createDatabaseSnapshotOK %s", 200, payload)
}
...
func (o *CreateDatabaseSnapshotUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /database][%d] createDatabaseSnapshotUnauthorized %s", 401, payload)
}
...
func (o *CreateDatabaseSnapshotTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /database][%d] createDatabaseSnapshotTooManyRequests %s", 429, payload)
}

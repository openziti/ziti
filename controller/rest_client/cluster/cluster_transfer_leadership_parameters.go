...
func (o *ClusterTransferLeadershipParams) WithMember(member *rest_model.ClusterTransferLeadership) *ClusterTransferLeadershipParams {
	o.SetMember(member)
	return o
}

// SetMember adds the member to the cluster transfer leadership params
func (o *ClusterTransferLeadershipParams) SetMember(member *rest_model.ClusterTransferLeadership) {
	o.Member = member
}

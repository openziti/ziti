...
func (h *getTerminatorHandler) HandleReceive(msg *channel.Message, ch channel.Channel) {
	...
	if err == nil {
		responseMsg := channel.NewMessage(int32(mgmt_pb.ContentType_GetTerminatorResponseType), body)

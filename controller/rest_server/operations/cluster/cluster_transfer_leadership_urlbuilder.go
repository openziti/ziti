...
func (o *ClusterTransferLeadershipURL) Build() (*url.URL, error) {
	...
	var _path = "/cluster/transfer-leadership"
...
func (o *ClusterTransferLeadershipURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ClusterTransferLeadershipURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ClusterTransferLeadershipURL")
	}

...
func (o *ClusterMemberRemoveURL) Build() (*url.URL, error) {
	...
	var _path = "/cluster/remove-member"
...
func (o *ClusterMemberRemoveURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ClusterMemberRemoveURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ClusterMemberRemoveURL")
	}

...
func (o *ClusterListMembersURL) Build() (*url.URL, error) {
	...
	var _path = "/cluster/list-members"
...
func (o *ClusterListMembersURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ClusterListMembersURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ClusterListMembersURL")
	}

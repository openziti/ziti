...
func (x *SessionConfirmation) GetSessionIds() []string {
	if x != nil {
		return x.SessionIds
	}
	return nil
...
var file_ctrl_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x35, 0x0a, 0x13, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1e, 0x0a, 0x0a, 0x73,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x73, 0x22, 0x8b, 0x03, 0x0a, 0x17,
	...
	0x65, 0x72, 0x6f, 0x10, 0x00, 0x12, 0x17, 0x0a, 0x12, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
...
var file_ctrl_proto_goTypes = []interface{}{
	...
	(*SessionConfirmation)(nil),          // 4: ctrl.pb.SessionConfirmation
	...
	nil,                                  // 17: ctrl.pb.SessionRequest.PeerDataEntry
...
var file_ctrl_proto_depIdxs = []int32{
	17, // 0: ctrl.pb.SessionRequest.peerData:type_name -> ctrl.pb.SessionRequest.PeerDataEntry
...
func file_ctrl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ctrl_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SessionConfirmation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

...
type ApiSessionAdded struct {
	...
	SyncStrategy         string        `protobuf:"bytes,3,opt,name=syncStrategy,proto3" json:"syncStrategy,omitempty"`
	SyncState            string        `protobuf:"bytes,4,opt,name=syncState,proto3" json:"syncState,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *ApiSessionAdded) GetSyncStrategy() string {
	if m != nil {
...
func (m *ApiSessionAdded) GetSyncState() string {
	if m != nil {
		return m.SyncState
	}
	return ""
...
func (m *SessionAdded) GetSyncStrategy() string {
	if m != nil {
		return m.SyncStrategy
	}
	return ""
...
func (m *SessionAdded) GetSyncState() string {
	if m != nil {
		return m.SyncState
	}
	return ""
...
var fileDescriptor_23f46a161f139ee1 = []byte{
	...
	,
}

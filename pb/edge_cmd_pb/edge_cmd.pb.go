...
var file_edge_cmd_proto_rawDesc = []byte{
	...
	0x0a, 0x0c, 0x5f, 0x66, 0x69, 0x6e, 0x67, 0x65, 0x72, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x22, 0x9d,
	...
	0x6e, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x1a, 0x53, 0x0a, 0x09, 0x54, 0x61, 0x67,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x30, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x7a, 0x69, 0x74, 0x69, 0x2e, 0x65,
	0x64, 0x67, 0x65, 0x5f, 0x63, 0x6d, 0x64, 0x2e, 0x70, 0x62, 0x2e, 0x54, 0x61, 0x67, 0x56, 0x61,
...
var file_edge_cmd_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_edge_cmd_proto_goTypes = []interface{}{
	...
	(*Mfa)(nil),                         // 11: ziti.edge_cmd.pb.Mfa
	(*Service)(nil),                     // 12: ziti.edge_cmd.pb.Service
	(*ServiceEdgeRouterPolicy)(nil),     // 13: ziti.edge_cmd.pb.ServiceEdgeRouterPolicy
	(*ServicePolicy)(nil),               // 14: ziti.edge_cmd.pb.ServicePolicy
	nil,                                 // 15: ziti.edge_cmd.pb.JsonMap.ValueEntry
	nil,                                 // 16: ziti.edge_cmd.pb.Config.TagsEntry
	nil,                                 // 17: ziti.edge_cmd.pb.ConfigType.TagsEntry
	(*AuthPolicy_Primary)(nil),          // 18: ziti.edge_cmd.pb.AuthPolicy.Primary
	(*AuthPolicy_Secondary)(nil),        // 19: ziti.edge_cmd.pb.AuthPolicy.Secondary
	nil,                                 // 20: ziti.edge_cmd.pb.AuthPolicy.TagsEntry
	(*AuthPolicy_Primary_Cert)(nil),     // 21: ziti.edge_cmd.pb.AuthPolicy.Primary.Cert
	(*AuthPolicy_Primary_Updb)(nil),     // 22: ziti.edge_cmd.pb.AuthPolicy.Primary.Updb
	(*AuthPolicy_Primary_ExtJwt)(nil),   // 23: ziti.edge_cmd.pb.AuthPolicy.Primary.ExtJwt
	(*Ca_ExternalIdClaim)(nil),          // 24: ziti.edge_cmd.pb.Ca.ExternalIdClaim
	nil,                                 // 25: ziti.edge_cmd.pb.Ca.TagsEntry
	nil,                                 // 26: ziti.edge_cmd.pb.EdgeRouterPolicy.TagsEntry
	nil,                                 // 27: ziti.edge_cmd.pb.ExternalJwtSigner.TagsEntry
	nil,                                 // 28: ziti.edge_cmd.pb.Mfa.TagsEntry
	nil,                                 // 29: ziti.edge_cmd.pb.Service.TagsEntry
	nil,                                 // 30: ziti.edge_cmd.pb.ServiceEdgeRouterPolicy.TagsEntry
	nil,                                 // 31: ziti.edge_cmd.pb.ServicePolicy.TagsEntry
	(*timestamppb.Timestamp)(nil),       // 32: google.protobuf.Timestamp
}
var file_edge_cmd_proto_depIdxs = []int32{
	15, // 0: ziti.edge_cmd.pb.JsonMap.value:type_name -> ziti.edge_cmd.pb.JsonMap.ValueEntry
	...
	16, // 3: ziti.edge_cmd.pb.Config.tags:type_name -> ziti.edge_cmd.pb.Config.TagsEntry
	3,  // 4: ziti.edge_cmd.pb.ConfigType.schema:type_name -> ziti.edge_cmd.pb.JsonMap
	17, // 5: ziti.edge_cmd.pb.ConfigType.tags:type_name -> ziti.edge_cmd.pb.ConfigType.TagsEntry
	18, // 6: ziti.edge_cmd.pb.AuthPolicy.primary:type_name -> ziti.edge_cmd.pb.AuthPolicy.Primary
	19, // 7: ziti.edge_cmd.pb.AuthPolicy.secondary:type_name -> ziti.edge_cmd.pb.AuthPolicy.Secondary
	20, // 8: ziti.edge_cmd.pb.AuthPolicy.tags:type_name -> ziti.edge_cmd.pb.AuthPolicy.TagsEntry
	25, // 9: ziti.edge_cmd.pb.Ca.tags:type_name -> ziti.edge_cmd.pb.Ca.TagsEntry
	24, // 10: ziti.edge_cmd.pb.Ca.externalIdClaim:type_name -> ziti.edge_cmd.pb.Ca.ExternalIdClaim
	26, // 11: ziti.edge_cmd.pb.EdgeRouterPolicy.tags:type_name -> ziti.edge_cmd.pb.EdgeRouterPolicy.TagsEntry
	27, // 12: ziti.edge_cmd.pb.ExternalJwtSigner.tags:type_name -> ziti.edge_cmd.pb.ExternalJwtSigner.TagsEntry
	32, // 13: ziti.edge_cmd.pb.ExternalJwtSigner.notAfter:type_name -> google.protobuf.Timestamp
	32, // 14: ziti.edge_cmd.pb.ExternalJwtSigner.notBefore:type_name -> google.protobuf.Timestamp
	28, // 15: ziti.edge_cmd.pb.Mfa.tags:type_name -> ziti.edge_cmd.pb.Mfa.TagsEntry
	29, // 16: ziti.edge_cmd.pb.Service.tags:type_name -> ziti.edge_cmd.pb.Service.TagsEntry
	30, // 17: ziti.edge_cmd.pb.ServiceEdgeRouterPolicy.tags:type_name -> ziti.edge_cmd.pb.ServiceEdgeRouterPolicy.TagsEntry
	31, // 18: ziti.edge_cmd.pb.ServicePolicy.tags:type_name -> ziti.edge_cmd.pb.ServicePolicy.TagsEntry
	4,  // 19: ziti.edge_cmd.pb.JsonMap.ValueEntry.value:type_name -> ziti.edge_cmd.pb.JsonValue
	2,  // 20: ziti.edge_cmd.pb.Config.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	2,  // 21: ziti.edge_cmd.pb.ConfigType.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	21, // 22: ziti.edge_cmd.pb.AuthPolicy.Primary.cert:type_name -> ziti.edge_cmd.pb.AuthPolicy.Primary.Cert
	22, // 23: ziti.edge_cmd.pb.AuthPolicy.Primary.updb:type_name -> ziti.edge_cmd.pb.AuthPolicy.Primary.Updb
	23, // 24: ziti.edge_cmd.pb.AuthPolicy.Primary.extJwt:type_name -> ziti.edge_cmd.pb.AuthPolicy.Primary.ExtJwt
	2,  // 25: ziti.edge_cmd.pb.AuthPolicy.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	2,  // 26: ziti.edge_cmd.pb.Ca.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	2,  // 27: ziti.edge_cmd.pb.EdgeRouterPolicy.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	2,  // 28: ziti.edge_cmd.pb.ExternalJwtSigner.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	2,  // 29: ziti.edge_cmd.pb.Mfa.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	2,  // 30: ziti.edge_cmd.pb.Service.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	2,  // 31: ziti.edge_cmd.pb.ServiceEdgeRouterPolicy.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
	2,  // 32: ziti.edge_cmd.pb.ServicePolicy.TagsEntry.value:type_name -> ziti.edge_cmd.pb.TagValue
